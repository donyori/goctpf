...
func mainProc(taskMgr goctpf.TaskManager,
	...
	for i := uint32(0); i < workerSettings.Number; i++ {
		runningWg.Add(1)
		go workerProc(taskHandler, workerSettings.SendErrTimeout,
			&runningWg, &taskWg, stChan, rtChan, workerErrChan,
			dwChan, seChan, reChan)
	}
